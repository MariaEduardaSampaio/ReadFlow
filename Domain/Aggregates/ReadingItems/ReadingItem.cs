...
public class ReadingItem
{
    ...
    public ReadingItem(Guid id, Guid bookId, Guid userId, EReadingStatus status, int currentPage, string review, 
        Rating rating, DateTime createdAt, DateTime beginningToRead, DateTime endedReading)
    {
        Id = id;
        BookId = bookId;
        UserId = userId;
